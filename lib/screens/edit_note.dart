...
//     String createdAt = widget.note != null ? widget.note.createdAt : "";
//     String noteId = widget.note != null ? widget.note.noteId : "";
//     final _formKey = GlobalKey<FormState>();
//     final _titleController = TextEditingController(text: title);
//     final _contentController = TextEditingController(text: content);
//     final _createdAtController = TextEditingController(text: createdAt);
//
...
//             backgroundColor: Colors.transparent,
//             title: Text(
//               widget.newNote ? 'Catatan Baru' : 'Perbarui Catatan',
...
//                 icon: Icon(widget.newNote ? Icons.add : Icons.update),
//                 label: Text(widget.newNote ? 'Tambah ' : 'Perbarui'),
//                 onPressed: () {
